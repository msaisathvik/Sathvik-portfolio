      ...
      <div className='flex flex-col gap-15  '>
        <fieldset className='border'>
          ...
          <div className='flex flex-row  w-[70vw] justify-around p-5 mt-5'>
            <p><img src="src\assets\C_Language_Logo.svg.png" alt="C Language" /></p>
            <p><img src="src\assets\c-plus-plus-programming-language-icon.png" alt="C++ Language" /></p>
            <p><img src="src\assets\python-programming-language-icon.png" alt="Python Language" /></p>
            <p><img src="src\assets\javascript-programming-language-icon.png" alt="JavaScript Language" /></p>
            <p><img src="src\assets\html-icon.png" alt="HTML" /></p>
            <p><img src="src\assets\css-icon.png" alt="CSS" /></p>
          </div>
