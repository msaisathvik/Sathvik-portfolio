      ...
      <div className='flex flex-col gap-15  '>
        <fieldset className='border'>
          ...
          <div className='flex flex-row  w-[70vw] justify-around p-5 mt-5'>
            ...
            <p><img src={`./public/assets/javascript-programming-language-icon.png`} alt="JavaScript Language" /></p>
            <p><img src={`./public/assets/html-icon.png`} alt="HTML" /></p>
            <p><img src={`./public/assets/css-icon.png`} alt="CSS" /></p>
          </div>
